...
/* Real-time model */
static RT_MODEL_our_model_T our_model_M_;
RT_MODEL_our_model_T *const our_model_M = &our_model_M_;
...
/* Model step function */
void our_model_step(void)
{
  if (rtmIsMajorTimeStep(our_model_M)) {
    /* set solver stop time */
    if (!(our_model_M->Timing.clockTick0+1)) {
      rtsiSetSolverStopTime(&our_model_M->solverInfo,
                            ((our_model_M->Timing.clockTickH0 + 1) *
        our_model_M->Timing.stepSize0 * 4294967296.0));
    } else {
      rtsiSetSolverStopTime(&our_model_M->solverInfo,
                            ((our_model_M->Timing.clockTick0 + 1) *
        our_model_M->Timing.stepSize0 + our_model_M->Timing.clockTickH0 *
        our_model_M->Timing.stepSize0 * 4294967296.0));
    }
  }                                    /* end MajorTimeStep */
  ...
  if (rtmIsMajorTimeStep(our_model_M)) {
    ...
    {                                  /* Sample time: [0.0s, 0.0s] */
      if ((rtmGetTFinal(our_model_M)!=-1) &&
          !((rtmGetTFinal(our_model_M)-(((our_model_M->Timing.clockTick1+
            ...
            (((our_model_M->Timing.clockTick1+our_model_M->Timing.clockTickH1*
    ...
    our_model_M->Timing.t[0] = rtsiGetSolverStopTime(&our_model_M->solverInfo);
...
void our_model_derivatives(void)
{
...
void our_model_initialize(void)
{
  /* Registration code */
  ...
  (void) memset((void *)our_model_M, 0,
                sizeof(RT_MODEL_our_model_T));

  {
    /* Setup solver object */
    rtsiSetSimTimeStepPtr(&our_model_M->solverInfo,
                          &our_model_M->Timing.simTimeStep);
    rtsiSetTPtr(&our_model_M->solverInfo, &rtmGetTPtr(our_model_M));
    rtsiSetStepSizePtr(&our_model_M->solverInfo, &our_model_M->Timing.stepSize0);
    rtsiSetdXPtr(&our_model_M->solverInfo, &our_model_M->derivs);
    rtsiSetContStatesPtr(&our_model_M->solverInfo, (real_T **)
                         &our_model_M->contStates);
    rtsiSetNumContStatesPtr(&our_model_M->solverInfo,
      &our_model_M->Sizes.numContStates);
    rtsiSetNumPeriodicContStatesPtr(&our_model_M->solverInfo,
      &our_model_M->Sizes.numPeriodicContStates);
  ...
  rtsiSetSolverData(&our_model_M->solverInfo, (void *)&our_model_M->intgData);
  ...
  /* Setup for data logging */
  {
    rtliSetLogXSignalInfo(our_model_M->rtwLogInfo, (NULL));
    rtliSetLogXSignalPtrs(our_model_M->rtwLogInfo, (NULL));
    ...
    rtliSetLogYSignalInfo(our_model_M->rtwLogInfo, (NULL));
    rtliSetLogYSignalPtrs(our_model_M->rtwLogInfo, (NULL));
  }

  /* block I/O */
  (void) memset(((void *) &our_model_B), 0,
                sizeof(B_our_model_T));

  /* states (continuous) */
  {
    (void) memset((void *)&our_model_X, 0,
                  sizeof(X_our_model_T));
  }
